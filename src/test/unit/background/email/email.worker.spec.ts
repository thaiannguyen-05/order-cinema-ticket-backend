...
describe('EmailWorker', () => {
  it('emits verify and reset events', () => {
    ...
    expect(client.emit).toHaveBeenNthCalledWith(1, EVENT_NAME.SEND_VERIFY_CODE, {
      email: 'a@example.com',
      code: '123456',
    });
    expect(client.emit).toHaveBeenNthCalledWith(2, EVENT_NAME.SEND_FORGOT_PASSWORD_EMAIL, {
      email: 'a@example.com',
      token: 'token-1',
    });
  });
