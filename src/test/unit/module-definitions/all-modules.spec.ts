...
const { AuthModule } =
  require('../../../module/core-module/auth/auth.module') as {
    AuthModule: unknown;
  };
const { UserModule } =
...
const { CinemaModule } =
  require('../../../module/theater-module/cinema/cinema.module') as {
    CinemaModule: unknown;
  };
const { SeatModule } =
  require('../../../module/theater-module/seat/seat.module') as {
    SeatModule: unknown;
  };
const { TicketModule } =
  require('../../../module/theater-module/ticket/ticket.module') as {
...
const { SyncDataCronJobModule } =
  require('../../../background/sync-data-cron-job/sync-data-cron-job.module') as {
